                ...
                for ll=1:length(Leaf)
                    ...
                    while k<Num_Sim
                        ...
                        try
                            ...
                            X_KNN_RMSE(k) = (X1(end,1)-Xhat_knn(end,1)).^2;
                            X_TREE_RMSE(k) = (X1(end,1)-Xhat_tree(end,1)).^2;
                            X_OT_RMSE(k) = (X1(end,1)-Xhat_Sink(end,1)).^2;
                    ...
                    clc;
                    filename=(['AfterJBES_EXPANDING_NP_RisSimul_NumVar',num2str(n),'_LungSerie',num2str(T),'_PercNan',num2str(10*prnan),...
                        'knr',num2str(kn), '.mat']);
